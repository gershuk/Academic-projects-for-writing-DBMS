...
namespace IntegrationTests
{
    ...
    class Insert_Delete : BaseSQLTest
    {
        ...
        public void InsertTest ()
        {
            ...
            /*
             INSERT INTO UnitMeasure (Name, UnitMeasureCode, ModifiedDate) VALUES ('FT2', 'Square Feet ', 20080923), ('Y', 'Yards', '20080923'), ('Y3', 'Cubic Yards', '20080923');
INSERT INTO UnitMeasure (UnitMeasureCode, Name, ModifiedDate) VALUES ('Square Feet ', 'FT2', '20080923'), ('Yards', 'Y', '20080923'), ('Cubic Yards', 'Y3', '20080923');
INSERT INTO UnitMeasure (Name, UnitMeasureCode, ModifiedDate) VALUES ('FT2', 'Square Feet ', 2+2*10), ('Y', 'Yards', (2+2)*10), ('Y3', 'Cubic Yards', 22+2);
INSERT INTO UnitMeasure (Name, UnitMeasureCode, ModifiedDate) VALUES ('FT2', 'Square Feet ', 12), ('Y', 'Yards', 11), ('Y3', 'Cubic Yards', 22/0);
INSERT INTO UnitMeasure (Name, UnitMeasureCode, ModifiedDate) VALUES ('FT2', 'Square Feet ', 55), ('Y', 'Yards', 55), ('Y3', 'Cubic Yards', 55);
INSERT INTO UnitMeasure (Name, UnitMeasureCode, ModifiedDate) VALUES ('FT2', 'Has not', 55);
INSERT INTO UnitMeasure2 (Name, UnitMeasureCode, ModifiedDate) VALUES ('FT2', 'Square Feet ', 77), ('Y', 'Yards', 77), ('Y3', 'Cubic Yards', 77);

DELETE FROM UnitMeasure WHERE ModifiedDate=40
DELETE FROM UnitMeasure WHERE ModifiedDate=20+2
DELETE FROM UnitMeasure WHERE RandomVar=20+2
DELETE FROM UnitMeasure WHERE ModifiedDate=(ModifiedDate-ModifiedDate)+20080923
DELETE FROM UnitMeasure WHERE ModifiedDate=40/0

CREATE TABLE UnitMeasure (Name CHAR(50),UnitMeasureCode CHAR(50), ModifiedDate INT);
DROP TABLE UnitMeasure;

UPDATE UnitMeasure SET ModifiedDate = ModifiedDate*2 WHERE ModifiedDate = 22;

SELECT UnitMeasure.Name, UnitMeasure.ModifiedDate FROM (UnitMeasure INNER JOIN UnitMeasure2 ON UnitMeasure.name = UnitMeasure2.name) WHERE ModifiedDate = 22
SELECT * FROM (UnitMeasure INNER JOIN UnitMeasure2 ON UnitMeasure2.UnitMeasureCode = UnitMeasure.UnitMeasureCode)
SELECT * FROM (UnitMeasure LEFT JOIN UnitMeasure2 ON UnitMeasure2.UnitMeasureCode = UnitMeasure.UnitMeasureCode)
SELECT Name FROM UnitMeasure WHERE ModifiedDate = 22
             */
